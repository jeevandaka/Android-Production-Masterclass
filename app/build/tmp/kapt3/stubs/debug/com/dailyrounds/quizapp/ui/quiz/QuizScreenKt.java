...
public final class QuizScreenKt {
    private static final float SWIPE_THRESHOLD_PX = 120.0F;
    
    /**
     * Everything -- loading, the question flow, and the results screen -- lives
     * behind one route driven by QuizUiState. There's no real "back stack" in
     * this flow (you can't navigate back to a finished quiz's questions), so a
     * single state machine is a more honest fit than spreading this across
     * multiple NavHost destinations that would need extra plumbing just to share
     * one ViewModel's data.
     */
