...
/**
 * Reads the bundled `assets/questions.json` file.
 *
 * This exists so the app is fully runnable offline / out-of-the-box the moment
 * you clone it -- no need to wait on network or a live gist before you can see
 * the quiz flow working. The repository tries the network first and only
 * falls back to this when that fails (see QuizRepositoryImpl).
 */
